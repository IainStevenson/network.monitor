...
SET filter="+[netmon.core*]* -[System.*]* -[System.Runtime.*]* -[Microsoft.*]* -[Microsoft.VisualStudio.TestPlatform.*]* -[Microsoft.CodeAnalysis.*]* -[Microsoft.VisualStudio.TestPlatform.TestSDKAutoGeneratedCode]* "
