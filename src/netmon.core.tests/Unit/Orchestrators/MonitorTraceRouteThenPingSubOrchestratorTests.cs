...
namespace netmon.core.tests.Integration.Orchestrators
{
    ...
    /// </summary>
    public class MonitorTraceRouteThenPingSubOrchestratorTests : TestBase<MonitorTraceRouteThenPingSubOrchestrator>
    {
        ...
        private ILogger<MonitorTraceRouteThenPingSubOrchestrator> _monitorOrchestratorLogger;
        ...
        public override void Setup()
        {
            ...
            _monitorOrchestratorLogger = Substitute.For<ILogger<MonitorTraceRouteThenPingSubOrchestrator>>();
            _unit = new MonitorTraceRouteThenPingSubOrchestrator(
        ...
        private MonitorTraceRouteThenPingSubOrchestrator CreateIsolatedUnit(PingResponses traceRouteResponses, PingResponses pingResponses)
        {
            ...
            return new MonitorTraceRouteThenPingSubOrchestrator(
                    _pingResponseModelStorageOrchestrator,
                    _traceRouteOrchestrator,
                    _pingOrchestrator,
                    _monitorOrchestratorLogger);
